...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _imgView.frame = CGRectMake(10, 5, 80, 100);
        [self addSubview:_imgView];
        
        _nameLabel = [[UILabel alloc]init];
        _nameLabel.frame = CGRectMake(100, 5, KScreenWidth-100-15-20, 30);
        ...
        _statusLabel.frame = CGRectMake(100, 40, KScreenWidth-100-15-20, 30);
        
        _statusLabel.font = font;
        [self addSubview:_statusLabel];
        
        _dateLabel = [[UILabel alloc]init];
        _dateLabel.frame = CGRectMake(100, 75, KScreenWidth-100-15-20, 30);
